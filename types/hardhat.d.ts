...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "IncomeSurvey",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.IncomeSurvey__factory>;
    getContractFactory(
      name: "IncomeSurveySepolia",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.IncomeSurveySepolia__factory>;
    getContractFactory(
      name: "IncomeSurveySimple",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.IncomeSurveySimple__factory>;
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.IncomeSurvey>;
    getContractAt(
      name: "IncomeSurveySepolia",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.IncomeSurveySepolia>;
    getContractAt(
      name: "IncomeSurveySimple",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.IncomeSurveySimple>;
